...
var Header = function Header() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      _reactRouterDom.Link,
      { className: 'btn btn-danger', to: '/battle' },
      'My Github Repo'
    )
  );
};
...
var _Battle = __webpack_require__(82);
...
var App = function App() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "div",
      null,
      _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: "/", component: _Languages2.default }),
...
var _Wrapper = __webpack_require__(50);
...
var _Repositories = __webpack_require__(80);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          loading ? 'Loading...' : _react2.default.createElement(_Repositories2.default, { repos: repos })
        )
      );
    }
  }]);
...
exports.default = (0, _Wrapper2.default)(Languages);
  ...
  return function (_Component) {
    ...
    function Wrapper() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Wrapper.__proto__ || Object.getPrototypeOf(Wrapper)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        ...
        repos: [],
        loading: true
      }, _this.selectLanguage = function (lang) {
        _this.setState({
          selected: lang,
          repos: []
        });
        fetch("https://api.github.com/search/repositories?q=stars:>1+language:" + lang + "&sort=starts&order=desc&type=Repositories").then(function (response) {
          return response.json();
        }).then(function (parsedJSON) {
          return parsedJSON.items.map(function (repo) {
            return {
              name: "" + repo.name,
    ...
    _createClass(Wrapper, [{
      ...
      key: "render",
      value: function render() {
        return _react2.default.createElement(Original, _extends({}, this.props, {
...
var Language = function Language(_ref) {
    ...
    return _react2.default.createElement(
        'div',
        { className: 'col-sm-2 col-xs-2 col-md-2' },
        _react2.default.createElement(
            'a',
            { className: lang === selected ? 'red' : 'black', onClick: onSelect.bind(null, lang) },
            lang
        )
    );
};
...
var _Repo = __webpack_require__(81);
...
var Repositories = function Repositories(_ref) {
  ...
  return _react2.default.createElement(
    ...
    repos.map(function (repo, i) {
      return _react2.default.createElement(
        'div',
        { key: i, className: 'col-md-4 col-sm-4 col-lg-3 col-xs-4 text-center', id: 'container' },
        _react2.default.createElement(_Repo2.default, { repo: repo, i: i })
      );
    })
  );
};
...
var Repo = function Repo(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement('img', { src: repo.image, className: 'img-circle img-responsive', alt: '' }),
        _react2.default.createElement(
            'a',
            { href: repo.link },
            '@',
...
var Battle = function (_Component) {
  ...
  function Battle() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Battle.__proto__ || Object.getPrototypeOf(Battle)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      name: '',
      image: '',
      url: '',
      bio: ''
  ...
  _createClass(Battle, [{
    ...
    value: function componentDidMount() {
      ...
      fetch('https://api.github.com/users/glebfedchenko').then(function (response) {
        return response.json();
      }).then(function (data) {
        _this2.setState({
          name: data.login,
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('img', { src: image, className: 'img-circle', alt: '' }),
          _react2.default.createElement(
            'p',
            null,
            bio
